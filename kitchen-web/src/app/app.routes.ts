...
export const routes: Routes = [
    ...
    { path: 'coupons', component: CouponComponent, canActivate: [()=> AuthGuardService(['ADMIN'])]},
    ...
    { path: 'products', component: ProductsComponent, canActivate: [()=> AuthGuardService(['SELLER'])] },
